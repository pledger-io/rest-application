...
public class BalanceRequest {
    ...
    public BalanceRequest(List<EntityRef> accounts, List<EntityRef> categories, List<EntityRef> contracts, List<EntityRef> expenses, DateRange dateRange, boolean onlyIncome, boolean allMoney, String currency, String importSlug) {
