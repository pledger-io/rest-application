...
public class CategoryResource {
    ...
    List<CategoryResponse> list() {
        return categoryService.lookup().map(CategoryResponse::new).toJava();
    }
    ...
    CategoryResponse create(@Valid @Body CategoryCreateRequest createRequest) {
        currentUserProvider.currentUser().createCategory(createRequest.name());
    ...
    void delete(@PathVariable long id) {
        categoryService.lookup(id).ifPresent(Category::remove);
    }
}
