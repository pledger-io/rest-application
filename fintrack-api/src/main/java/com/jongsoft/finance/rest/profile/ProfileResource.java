...
public class ProfileResource {
    ...
    public UserProfileResponse patch(@Body PatchProfileRequest request) {
        ...
        if (request.password() != null) {
            userAccount.changePassword(
                    application.getHashingAlgorithm().encrypt(request.password()));
        }
    ...
    @Operation(
            ...
            description =
                    "This will activate 2-factor authentication when the security code matches the"
                            + " one recorded")
    ...
    @Operation(
            ...
            description =
                    "This operation will disable 2-factor authentication, but will only work if it"
