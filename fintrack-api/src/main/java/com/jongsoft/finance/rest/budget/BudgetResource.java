...
public class BudgetResource {
  ...
  @Put
  @Operation(summary = "Create initial budget", description = "Create a new budget in the system.")
  @ApiResponse(
      responseCode = "400",
  ...
  BudgetResponse patchBudget(@Valid @Body BudgetCreateRequest patchRequest) {
    ...
    return budgetProvider
        ...
        .map(BudgetResponse::new)
        .getOrThrow(
            () -> StatusException.internalError("Could not get budget after updating the period."));
  }
