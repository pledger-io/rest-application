...
public class AccountEditResource {
    ...
    @Operation(
            summary = "Get Account",
            description =
                    "Attempts to get the account with matching account id. If no account is found"
            ...
            responses = {
                @ApiResponse(
                        ...
                        content =
                                @Content(schema = @Schema(implementation = AccountResponse.class))),
    ...
    @Operation(
            ...
            description =
                    "Update an existing account with the new details provided in the body. The"
    ...
    @Operation(
            summary = "Attach icon",
            description =
                    "Attach an icon to the account. If any icon was previously registered it will"
