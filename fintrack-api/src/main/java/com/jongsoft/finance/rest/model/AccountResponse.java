...
public class AccountResponse {
    ...
    @Schema(description = "The account name, is unique for the user", example = "Fast food & co", required = true)
    ...
    @Schema(description = "The type of account, as defined by the account type API", example = "creditor", required = true)
    ...
    @Schema(description = "The interest information for the account, only used for loans, debts and mortgage")
    ...
    @Schema(description = "The saving goals for the account, only valid for type savings and joined_savings")
    ...
    public class SavingGoalResponse {
        ...
        @Schema(description = "The goal one wishes to achieve by the end date", type = "number", example = "1500.40", required = true)
        public BigDecimal getGoal() {
            return wrapped.getGoal();
        }

        @Schema(description = "The amount of money reserved for this saving goal", type = "number", example = "200", required = true)
        public BigDecimal getReserved() {
            return wrapped.getAllocated();
        }

        @Schema(description = "The amount of money allocated each interval, only when schedule is set", type = "number", example = "25.50")
        ...
        @Schema(description = "The date before which the goal must be met", example = "2021-01-12", required = true)
