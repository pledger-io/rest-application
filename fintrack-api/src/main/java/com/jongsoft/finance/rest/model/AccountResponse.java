...
public class AccountResponse {
  ...
  @Schema(
      description =
          "The interest information for the account, only used for loans, debts and" + " mortgage")
  ...
  @Schema(
      description =
          "The saving goals for the account, only valid for type savings and" + " joined_savings")
  ...
  public static class SavingGoalResponse {
    ...
    @Schema(
        description = "The amount of money allocated each interval, only when schedule is set",
        type = "number",
        example = "25.50")
