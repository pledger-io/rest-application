...
public class AccountTopResource {
  ...
  @Operation(
      ...
      description =
          "Calculates and returns the accounts where you spent the most for the given date range",
  ...
  @Operation(
      ...
      description =
          "Calculates and returns the accounts that credited the most money for the given date range",
