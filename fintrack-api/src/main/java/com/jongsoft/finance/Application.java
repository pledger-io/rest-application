...
@OpenAPIDefinition(
    info =
        @Info(
            title = "Pledger",
            version = "2.0.0",
            description = "Pledger.io is a self-hosted personal finance application that"
    ...
    tags = {
      ...
      @Tag(
          ...
          description =
              "API for importing transactions from external sources and file" + " formats."),
      @Tag(
      ...
      @Tag(
          ...
          description = "API for managing tags and labels associated with transactions for"
              + " better organization."),
      @Tag(
      ...
      @Tag(
          ...
          description = "API for managing automated business processes and workflows related to"
              + " financial data."),
      @Tag(
          name = TAG_SETTINGS,
      ...
      @Tag(
          name = TAG_SECURITY,
          description =
              "API for managing security settings, permissions, and access" + " controls."),
      @Tag(
          name = TAG_SECURITY_USERS,
          description = "API for user management, including creation, updates, and permission"
              + " assignments."),
    })
@SecurityScheme(
    name = "bearer",
