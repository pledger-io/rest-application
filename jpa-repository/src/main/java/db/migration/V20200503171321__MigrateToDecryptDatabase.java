...
//        var name = API.Option(rs.getString("name")).map(encryptor::decrypt).getOrSupply(() -> null);
//        var iban = API.Option(rs.getString("iban")).map(encryptor::decrypt).getOrSupply(() -> null);
//        var bic = API.Option(rs.getString("bic")).map(encryptor::decrypt).getOrSupply(() -> null);
//        var number = API.Option(rs.getString("number")).map(encryptor::decrypt).getOrSupply(() -> null);
//
