...
/**
 * Enumeration representing various field equations that can be used in expressions.
 * The options include EQ for equality, GTE for greater than or equal to, LT for less than,
 * LTE for less than or equal to, IN for inclusion, NIN for exclusion, and LIKE for string pattern matching.
 */
public enum FieldEquation {
    ...
    LT,
    /**
     * Enumeration representing the field equation option for less than or equal to comparison in expressions.
     */
    LTE,
    /**
