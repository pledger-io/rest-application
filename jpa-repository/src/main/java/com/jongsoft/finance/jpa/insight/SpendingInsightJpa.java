...
public class SpendingInsightJpa extends EntityJpa {
    ...
    @ElementCollection
    @CollectionTable(name = "spending_insight_metadata", joinColumns = @JoinColumn(name = "insight_id"))
    ...
    @Builder
    private SpendingInsightJpa(InsightType type, String category, Severity severity,
                              double score, LocalDate detectedDate, String message,
                              YearMonth yearMonth, Map<String, String> metadata,
                              Long transactionId,
                              UserAccountJpa user) {
        this.type = type;
