...
public final class Expressions {
  ...
  public static ComputationExpression caseWhen(
      BooleanExpression expression, ComputationExpression then, ComputationExpression elseValue) {
    return new ComputationExpression() {
      @Override
      public String hqlExpression() {
        return "CASE WHEN %s THEN %s ELSE %s END"
            .formatted(expression.hqlExpression(), then.hqlExpression(), elseValue.hqlExpression());
      }
