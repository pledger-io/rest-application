...
public interface Query<Q extends Query<Q>> {
    ...
    /**
     * Retrieves a query instance with a conditional check where the specified field's value is similar to the provided condition.
     *
    ...
    /**
     * Retrieves a query instance with a conditional check where the specified field's value falls between the provided start and end values.
     *
    ...
    /**
     * Adds a condition to the query where the specified field is not equal to any of the provided conditions.
     *
    ...
    /**
     * Adds a condition to the query where the specified field is greater than or equal to the provided condition.
     *
     * @param field the field to apply the greater than or equal condition
     * @param condition the condition value to match
     * @return the updated SimpleQuery instance with the specified greater than or equal condition added
     */
    ...
    /**
     * Retrieves a query instance with a conditional check where the specified field's value is less than or equal to the provided condition.
     *
    ...
    /**
     * Executes the given subQueryBuilder only if it does not exist in the context of the current query.
     *
     * @param subQueryBuilder the consumer function defining the sub-query to be checked for non-existence
