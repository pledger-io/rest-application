...
public class ReactiveEntityManager {
     ...
     * @return A new JpaQuery instance configured with the entity manager and entity type extracted from the filterBuilder
     */
     ...
     */
    public static <T> Collector<T, ? extends ArrayList<T>, ? extends Sequence<T>> sequenceCollector() {
