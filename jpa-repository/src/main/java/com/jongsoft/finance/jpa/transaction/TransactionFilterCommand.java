...
public class TransactionFilterCommand extends JpaFilterBuilder<TransactionJournal> implements TransactionProvider.FilterCommand {
    ...
    public TransactionFilterCommand() {
        query().fieldNull("deleted")
                .condition(Expressions.fieldNull("t", "deleted"));
    ...
    public TransactionProvider.FilterCommand onlyIncome(boolean onlyIncome) {
        query().condition(Expressions.fieldCondition("t", "amount", onlyIncome ? FieldEquation.GTE : FieldEquation.LTE, 0));
        return this;
    }
    ...
    public TransactionProvider.FilterCommand ownAccounts() {
        ...
        query()
                .condition(Expressions.fieldCondition("t", "account.type.label", FieldEquation.NIN, Arrays.asList(types)))
