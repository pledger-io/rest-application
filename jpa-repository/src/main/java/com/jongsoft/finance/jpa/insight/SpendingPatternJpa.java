...
public class SpendingPatternJpa extends EntityJpa {
    ...
    @ElementCollection
    @CollectionTable(name = "spending_pattern_metadata", joinColumns = @JoinColumn(name = "pattern_id"))
    ...
    @Builder
    private SpendingPatternJpa(PatternType type, String category, double confidence,
                              LocalDate detectedDate, YearMonth yearMonth,
                              Map<String, String> metadata, UserAccountJpa user) {
        this.type = type;
