...
public abstract class BaseQuery<Q extends Query<Q>> implements Query<Q> {
    protected record InnerQuery(String fieldCondition, SubQuery subQuery) implements BooleanExpression {
        @Override
    ...
    public Q fieldIn(String field, Class<?> subQueryEntity, Consumer<SubQuery> subQueryBuilder) {
        ...
        var qubQuery = new SubQuery(tableAlias, BaseQuery.generateRandomString())
                .from(subQueryEntity);
