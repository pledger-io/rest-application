...
import com.jongsoft.finance.rest.ProfileApi;
...
class ProfileController implements ProfileApi {
    ...
    public ProfileController(
            UserProvider userProvider, AuthenticationFacade authenticationFacade, Encoder encoder) {
    ...
    public HttpResponse<@Valid SessionResponse> createSession(
        ...
        Application.registerUserToken(
                user, tokenForSession, sessionRequest.getExpires().atTime(LocalTime.MIN));
