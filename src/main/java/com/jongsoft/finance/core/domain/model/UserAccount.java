...
public class UserAccount implements Serializable {
    ...
    UserAccount(
        ...
        this.roles = Collections.List(roles);
        this.theme = theme;
    ...
    private UserAccount(String username, String externalUserId, List<String> roles) {
        this.username = new UserIdentifier(username);
        this.externalUserId = externalUserId;
    ...
    public void changeCurrency(Currency currency) {
        if (!Objects.equals(this.primaryCurrency, currency)) {
            ...
            ChangeUserSettingCommand.userSettingChanged(
                    ...
                    primaryCurrency.getCurrencyCode());
        }
    }
    ...
    //                    "User cannot create accounts, incorrect privileges.");
    //        }
    //
    ...
    //        if (notFullUser()) {
    //            throw StatusException.notAuthorized(
    //                    "User cannot create categories, incorrect privileges.");
    //        }
    //
    ...
    //        if (notFullUser()) {
    //            throw StatusException.notAuthorized("User cannot create rules, incorrect
    // privileges.");
    //        }
    //
    ...
    //     */
    //    public BatchImportConfig createImportConfiguration(String type, String name, String
    // fileCode) {
    //        if (notFullUser()) {
    //            throw StatusException.notAuthorized(
    ...
    //        if (notFullUser()) {
    //            throw StatusException.notAuthorized(
    //                    "User cannot create budgets, incorrect privileges.");
    //        }
    //
    ...
    public boolean notFullUser() {
        return roles.stream()
                .noneMatch(r -> Objects.equals(r.name(), "accountant")
                        || Objects.equals(r.name(), "admin"));
    }
    ...
    public static UserAccount create(String username, String externalUserId, List<String> roles) {
        return new UserAccount(username, externalUserId, roles);
    }
}
