...
class LearningRuleCommandController implements LearningRuleCommandApi {
    ...
    public HttpResponse<@Valid RuleResponse> createRule(String group, RuleRequest ruleRequest) {
        ...
        TransactionRule rule = TransactionRule.create(
                ruleRequest.getName(), ofNullable(ruleRequest.getRestrictive()).orElse(false));
    ...
    @Override
    public HttpResponse<Void> createRuleGroup(RuleGroupResponse ruleGroup) {
    ...
    public RuleResponse updateRule(String group, Long ruleId, RuleRequest ruleRequest) {
        ...
        rule.getChanges().forEach(TransactionRule.Change::delete);
        rule.getConditions().forEach(TransactionRule.Condition::delete);
    ...
    public HttpResponse<Void> updateRuleGroup(
            String group, RuleGroupPatchRequest patchRuleGroupRequest) {
