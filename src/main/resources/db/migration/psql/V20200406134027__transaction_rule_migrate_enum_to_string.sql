...
alter table rule_change rename column tp_enum to field;
...
alter table rule_condition rename column tp_enum to field;
...
alter table rule_condition rename column tp_enum to operation;
