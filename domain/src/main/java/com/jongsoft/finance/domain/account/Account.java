...
public class Account implements AggregateBase, Serializable {
  ...
  public void changeAccount(String iban, String bic, String number) {
    var noChanges =
        Control.Equal(this.iban, iban).append(this.bic, bic).append(this.number, number).isEqual();
  ...
  /**
   * Create a new saving goal for the account. This can only be done for accounts of type SAVING or
   * COMBINED_SAVING.
   *
