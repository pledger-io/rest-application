...
public record ChangeCurrencyPropertyCommand<T extends Serializable>(String code, T value, CurrencyCommandType type)
    ...
    public static <T extends Serializable> void currencyPropertyChanged(String code, T value, CurrencyCommandType type) {
        new ChangeCurrencyPropertyCommand<>(code, value, type)
                .publish();
    }
}
