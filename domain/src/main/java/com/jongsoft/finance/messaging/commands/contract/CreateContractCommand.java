...
public record CreateContractCommand(long companyId, String name, String description, LocalDate start, LocalDate end)
    ...
    /**
     * Creates a new contract with the provided details and publishes it to the event bus for further processing.
     *
     ...
     */
    public static void contractCreated(long companyId, String name, String description, LocalDate start, LocalDate end) {
        new CreateContractCommand(companyId, name, description, start, end)
                .publish();
    }
}
