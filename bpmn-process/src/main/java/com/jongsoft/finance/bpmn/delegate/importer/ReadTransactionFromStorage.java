 ...
 *
 * <p>This delegate reads a transaction from storage using the {@code storageToken} provided in the
 * process variables. The transaction is then stored in the process variables as {@code
 * transaction}. The transaction is stored as a {@link TransactionDTO} object.
 */
@Singleton
