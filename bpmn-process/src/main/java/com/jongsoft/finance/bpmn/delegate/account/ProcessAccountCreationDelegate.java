...
/**
 * This delegate reads a JSON serialized as a variable and processes it into an {@link Account} that
 * will be created.
 *
 * <p>This delegate expects the following variables to be present:
 *
 * <ul>
 *   <li>account, the serialized {@link AccountJson} used to create the account
 * </ul>
 */
@Slf4j
@Singleton
