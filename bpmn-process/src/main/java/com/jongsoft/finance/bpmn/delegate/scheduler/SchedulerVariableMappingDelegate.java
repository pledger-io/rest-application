...
public class SchedulerVariableMappingDelegate implements DelegateVariableMapping {
    ...
    public void mapInputVariables(DelegateExecution superExecution, VariableMap subVariables) {
        log.debug("{}: Mapping input variables for sub process {}", superExecution.getCurrentActivityName(),
        ...
        var scheduledDate = LocalDate.ofInstant(((Date)superExecution.getVariable("nextRun")).toInstant(),
    ...
    public void mapOutputVariables(DelegateExecution superExecution, VariableScope subInstance) {
        log.debug("{}: Mapping output variables for sub process {}", superExecution.getCurrentActivityName(),
                superExecution.getVariable(SUB_PROCESS));
