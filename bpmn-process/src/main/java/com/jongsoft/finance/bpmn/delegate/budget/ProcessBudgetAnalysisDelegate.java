...
public class ProcessBudgetAnalysisDelegate implements JavaDelegate, JavaBean {
  ...
  public void execute(DelegateExecution execution) {
    var forExpense =
        execution.<ObjectValue>getVariableLocalTyped("expense").getValue(Budget.Expense.class);
    var runningDate =
    ...
    var searchCommand =
        filterFactory.transaction().expenses(Collections.List(new EntityRef(forExpense.getId())));
