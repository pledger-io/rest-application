...
public class ImportTransactionJsonDelegate implements JavaDelegate, JavaBean {
    ...
    public ImportTransactionJsonDelegate(
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.debug(
                "{}: Importing a transaction from '{}' to '{}'.",
                        ...
                        .getOrThrow(
                                () ->
                                        new IllegalStateException(
                                                "Unable to find account with name "
                                                        + transaction.getFromAccount()));
        var toAccount =
                accountProvider
        ...
        long transactionId =
                creationHandler.handleCreatedEvent(new CreateTransactionCommand(created));
