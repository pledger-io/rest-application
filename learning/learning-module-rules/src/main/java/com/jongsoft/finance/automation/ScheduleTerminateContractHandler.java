...
/**
 * This class will automatically terminate all active transaction schedules attached to the contract
 * that was terminated. This will prevent new transactions from being made after a contract is
